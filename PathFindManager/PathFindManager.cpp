...
PathFindAlgorithm*  g_pPathFindManager = nullptr;
    ...
    _In_ int       nCmdShow)
{
    ...
    g_pMapTool = new MapTool;
     ...
     g_pPathFindManager = new JumpPointSearch;
    ...
    {
        if (g_pPathFindManager->GetFindPathOn())
        {
             g_pPathFindManager->FindPath();
            InvalidateRect(hWnd, NULL, false);
        }

        TranslateMessage(&msg);
        DispatchMessage(&msg); // WndProc 로
    }
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    SetTimer(hWnd, 1, 20, NULL); // 20ms마다 WM_TIMER 발생
    ...
    case WM_KEYDOWN:
        ...
        case 0x31: // Key Num 1
            ...
            delete  g_pPathFindManager;
             g_pPathFindManager = new AStar;
            break;
        ...
        case 0x51: // Key Q
             g_pPathFindManager->SetDebugCreateNode(true);
            break;

        case 0x57: // Key W
             g_pPathFindManager->SetDebugCreateNode(false);
            break;

        case 0x41: // Key A
             g_pPathFindManager->SetDebugFindCorner(true);
            break;

        case 0x53: // Key S
             g_pPathFindManager->SetDebugFindCorner(false);
            break;

        case 0x5A: // Key Z
             g_pPathFindManager->SetDebugOpenList(true);
            break;

        case 0x58: // Key X
             g_pPathFindManager->SetDebugOpenList(false);
            break;

        case 0x43: // Key C
             g_pPathFindManager->SetCorrectPath(true);
            break;

        case 0x56: // Key V
             g_pPathFindManager->SetCorrectPath(false);
            break;
        ...
        case VK_SPACE:
             g_pPathFindManager->FindPathStepInto();
            InvalidateRect(hWnd, NULL, false);
            break;

        case VK_RETURN:
             g_pPathFindManager->StartFindPath();
            InvalidateRect(hWnd, NULL, false);
            break;
